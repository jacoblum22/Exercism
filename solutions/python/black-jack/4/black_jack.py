...
def higher_card(card_one, card_two):
    ...
    if card1_val > card2_val: return card_one
    if card2_val > card1_val: return card_two
...
def value_of_ace(card_one, card_two):
    ...
    if value_of_card(card_one) + value_of_card(card_two) > 10: return 1
    return 11
...
def is_blackjack(card_one, card_two):
    ...
    card_vals = {value_of_card(card_one), value_of_card(card_two)}
    return 1 in card_vals and 10 in card_vals
